...
#+BEGIN_SRC emacs-lisp
  ...
  (if (string= (system-name) "TheBeast")
      (add-to-list 'exec-path "/home/iyan/.local/bin"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;	 (code-font "Space Mono Nerd Font")
	   (code-font "Operator Mono")
  ;	   (vari-font "Libre Baskerville")
	   (vari-font "Operator Mono"))
      ...
      (set-face-attribute 'variable-pitch nil :family vari-font :height 275)
      (set-face-attribute 'default nil :family code-font :height 280)
...
#+BEGIN_SRC emacs-lisp
  (defun my/tangle-on-save-emacs-config-org-file ()
    (when (string= buffer-file-name (file-truename "~/Dropbox/dot-files/emacs.org"))
      (org-babel-tangle)))
